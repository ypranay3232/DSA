...
int main()
{
    ...
    // not at all This metho =d is Flawed, here we are checking if a number is odd (num % 2 ==1 so odd) but not all odd numbers are prime ex : 9 and we don't counter (numbers which are -ve)

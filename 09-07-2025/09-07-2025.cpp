...
int main(){
    ...
    // exercise : print even numbers from 1 to N. so here first we read input from N. and run a loop and start checking the N from 2(bcz even numbers start from 2) and if N =5( loops starts with 2 and prints it and then increment i = i +2, untill i < = N) else stop.
